...
public class TransactionService {
    ...
    public void debit(transactionDTO transactionDTO) throws WalletNotFoundException, NotEnoughCreditException, TransactionIdRedundantException {
        ...
        if (newBalance.compareTo(BigDecimal.ZERO) < 0) {
            ...
            throw new NotEnoughCreditException(transactionDTO.getPlayerId(), "Not enough money on balance");
        }
    ...
    private void checkTransactionId(transactionDTO transactionDTO) throws TransactionIdRedundantException {
        ...
        if (transaction.isPresent()) {
            ...
            throw new TransactionIdRedundantException(transactionDTO.getPlayerId(), "Transaction already exists");
        }
    }

    private final void makeTransaction(transactionDTO transactionDTO, Wallet wallet, BigDecimal newBalance, TransactionType transactionType) {
